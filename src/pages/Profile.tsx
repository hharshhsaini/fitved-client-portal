...
export default function Profile() {
  ...
  const trainerInitials = mockProfile.trainerName.split(" ").map((p) => p[0]).slice(0, 2).join("");
    ...
    <div className="space-y-6">
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>Update your contact details. Changes are saved instantly.</DialogDescription>
            </DialogHeader>
            ...
            <DialogFooter>
              ...
              <Button onClick={() => { toast.success("Profile updated"); setOpen(false); }}>Save changes</Button>
            </DialogFooter>
          </DialogContent>
        </Dialog>
      </header>
      ...
      <Card className="p-6 md:p-8 rounded-2xl shadow-card">
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2">
          ...
          <InfoRow icon={MapPin} label="Society" value={mockProfile.society} />
          <InfoRow icon={Clock} label="Time slot" value={mockProfile.timeSlot} />
        </div>
      </Card>
      ...
      <Card className="p-6 rounded-2xl shadow-card">
        ...
        <div className="mt-4 flex items-center gap-4">
          ...
          <div>
            <p className="font-medium text-lg">{mockProfile.trainerName}</p>
            <p className="text-sm text-muted-foreground flex items-center gap-1.5">
              <UserRound className="h-3.5 w-3.5" /> {mockProfile.trainerSpecialty}
            </p>
          </div>
        </div>
      </Card>
